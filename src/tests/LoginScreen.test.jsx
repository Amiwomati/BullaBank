...
describe('LoginScreen', () => {
  ...
  test('should render login form correctly', () => {
    ...
    expect(screen.getByText('Ingrese sus credenciales para acceder a su cuenta')).toBeInTheDocument();
  ...
  test('should save email to localStorage when remember me is checked', async () => {
    ...
    await waitFor(() => {
      expect(localStorage.setItem).toHaveBeenCalledWith('bullabank_email', 'test@example.com');
    });
  });
});
