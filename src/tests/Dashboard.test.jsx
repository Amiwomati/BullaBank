...
describe('Dashboard', () => {
  ...
  test('should render dashboard with user information', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('Bienvenido a tu Banca en Línea')).toBeInTheDocument();
  ...
  test('should render recent transactions', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('Transferencia a Juan Pérez')).toBeInTheDocument();
  ...
  test('should close transfer modal when close button is clicked', async () => {
    ...
    await waitFor(() => {
      expect(screen.queryByText('Realizar Transferencia')).not.toBeInTheDocument();
    });
  });
  ...
  test('should handle transfer form submission', async () => {
    ...
    await waitFor(() => {
      const destinationInput = screen.getByPlaceholderText('Nombre o RUT del destinatario');
  ...
  test('should handle logout error', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('Error al cerrar sesión. Por favor intente nuevamente.')).toBeInTheDocument();
    });
  });
